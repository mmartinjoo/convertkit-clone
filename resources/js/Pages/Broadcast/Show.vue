    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-12 max-w-7xl mx-auto">
            ...
            <div v-if="filters().tagIds.length">
                Tag filters:
                <span v-for="tagId in filters().tagIds" class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-white bg-gray-400 rounded-full">
                    {{ formTitle(tagId) }}
                </span>
            </div>

            <button v-if="model.broadcast.status === 'draft'" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-3 mt-6" type="button">
                Delete
            </button>
